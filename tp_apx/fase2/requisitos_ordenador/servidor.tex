...
\begin{enumerate}
  ...
  \item \underline{Impresora láser}
    \begin{itemize}
      \item Marca: Hewlett Packard
      \item Modelo: LaserJet 1018
      \item Cantidad de disparadores de chorro: 
      
      \item Resolución máxima: 600 x 600 ppp
      \item Velocidad: 20 ppm.
      \item Salida de la primera página (negro, A4): < 10 s
      \item Interface: USB.
      
      \item Velocidad máxima de impresión a en escala de grises:
      \item Resolución máxima en calidad borrador: 600 x 600 ppp
      \item Resolución máxima en calidad normal: 600 x 600 ppp
      \item Resolución máxima en calidad óptima: 600 x 600 ppp
      
      \item Tipo de papel: Papel de copiadora, bond, multipropósito
      \item Tamaños de papel soportados: A4, A5, A6, B5, postales, sobres
