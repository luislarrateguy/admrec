\section{Estimación de los requisitos del equipo}

\subsection{Espacio de almacenamiento:}
\begin{itemize}
  \item \FIXME{Esto se puede hacer mucho mejor con tablas}
...
\begin{itemize}
  ...
  \item \FIXME{Leer las aclaraciones que hay en el documento original}
\end{itemize}
